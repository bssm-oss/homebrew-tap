class Whatdid < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/bssm-oss/whatdid/releases/download/v0.2.0/whatdid-darwin-arm64.tar.gz"
      sha256 "4a2ef324337e1266cc5b9bce986465bd8cae3a72cb46fcd6b2343233ffc62443"
    end
    on_intel do
      url "https://github.com/bssm-oss/whatdid/releases/download/v0.2.0/whatdid-darwin-amd64.tar.gz"
  ...
  on_linux do
    on_arm do
      url "https://github.com/bssm-oss/whatdid/releases/download/v0.2.0/whatdid-linux-arm64.tar.gz"
      sha256 "752ba40a4c05b3a342ddf6a37c7a9a28ea3c5f55411f83acd03c3ea6565f02dd"
    end
    on_intel do
      url "https://github.com/bssm-oss/whatdid/releases/download/v0.2.0/whatdid-linux-amd64.tar.gz"
